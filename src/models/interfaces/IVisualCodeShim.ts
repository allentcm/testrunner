...
import { IVisualCodeDocumentShim } from "./IVisualCodeDocumentShim";

/**
 * This interface defines functionality that the extension uses to interface with the Visual Code UI.
...
export interface IVisualCodeShim {
  ...
  addDiagnostic(
    documentURI: IVisualCodeDocumentShim,
    identifier: string,
