import { IVisualCodePositionShim } from "./IVisualCodePositionShim";

/**
 * This interface defines functionality that the extension uses to interface with a Visual Code document.
