...
import { IVisualCodeQuickPickItem, IVisualCodeShim } from "../../models/interfaces/IVisualCodeShim";
import { PHPTestFunctionInfo } from "../../models/PHPTestFunctionInfo";
import { VisualCodeDocumentShimMock } from "./unit/VisualCodeDocumentShimMock";
...
export class VisualCodeShimMock implements IVisualCodeShim {
  ...
  addDiagnostic(
    _document: IVisualCodeDocumentShim,
    _identifer: string,
